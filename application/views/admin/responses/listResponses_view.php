            ...
            <div class="col-12 ls-flex-column">
                ...
                <div id='bottom-scroller' class="content-right scrolling-wrapper"    >
                    ...
                    <?php
                        ...
                        if (in_array('lastpage', $filteredColumns)) {
                            $aColumns[] = array(
                                'header' => 'lastpage',
                                'name' => 'lastpage',
                                'type' => 'number',
                        ...
                        if (in_array('completed', $filteredColumns)) {
                            $aColumns[] = array(
                                'header' => gT("completed"),
                        ...
                        if ($bHaveToken) {
                            if (in_array('token', $filteredColumns)) {
                                $aColumns[] = array(
                                    'header' => 'token',
                                    'name' => 'token',
                                    'type' => 'raw',
                            ...
                            if (in_array('firstname', $filteredColumns)) {
                                $aColumns[] = array(
                            ...
                            if (in_array('lastname', $filteredColumns)) {
                                $aColumns[] = array(
                                    'header' => gT("Last name"),
                            ...
                            if (in_array('email', $filteredColumns)) {
                                $aColumns[] = array(
                                    'header' => gT("Email"),
                                    'name' => 'tokens.email',
                                    'id' => 'email',
                        ...
                        if (in_array('startlanguage', $filteredColumns)) {
                            $aColumns[] = array(
                    ...
                    // An array to control unicity of $code (EM code)
                        foreach($model->metaData->columns as $column)
                        {
                            if(!in_array($column->name, $aDefaultColumns))
                            {
                                ...
                                if (in_array($column->name, $filteredColumns)) {
                                    $aColumns[] = array(
