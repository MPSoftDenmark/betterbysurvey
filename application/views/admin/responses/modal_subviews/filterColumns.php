            ...
            <form action="<?= App()->createUrl('/admin/responses/sa/setfilteredcolumns/', ['surveyid' => $surveyid]) ?>" class="pjax" method="POST" data-filtered-columns=<?php echo json_encode($filteredColumns) ?>>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group responses-multiselect-checkboxes">
                        <?php foreach ($surveyColumns as $columnName => $surveyColumn): ?>
                            <div class="checkbox">
                                <label>
                                    <input name="columns[]" type="checkbox" value="<?php echo $columnName ?>"<?php echo in_array($columnName, $filteredColumns) ? 'checked' : '' ?>>
                                    <?php echo $surveyColumn ?>
                                </label>
                            </div>
                        <?php endforeach; ?>
